...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SimilarityCheckResponseInputParams'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SimilarityCheckResponseInputParams'));
  } else {
    // Browser globals (root is window)
    if (!root.WikitudeStudioApiClient) {
      root.WikitudeStudioApiClient = {};
    }
    root.WikitudeStudioApiClient.SimilarityCheckResponse = factory(root.WikitudeStudioApiClient.ApiClient, root.WikitudeStudioApiClient.SimilarityCheckResponseInputParams);
  }
}(this, function(ApiClient, SimilarityCheckResponseInputParams) {
  'use strict';
  ...
  /**
   * The SimilarityCheckResponse model module.
   * @module model/SimilarityCheckResponse
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>SimilarityCheckResponse</code>.
   * @alias module:model/SimilarityCheckResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>SimilarityCheckResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SimilarityCheckResponse} obj Optional instance to populate.
   * @return {module:model/SimilarityCheckResponse} The populated <code>SimilarityCheckResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('inputParams')) {
        obj['inputParams'] = SimilarityCheckResponseInputParams.constructFromObject(data['inputParams']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/SimilarityCheckResponseInputParams} inputParams
   */
