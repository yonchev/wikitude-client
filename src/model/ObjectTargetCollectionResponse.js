...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ObjectTargetCollectionResponseWto'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ObjectTargetCollectionResponseWto'));
  } else {
    // Browser globals (root is window)
    if (!root.WikitudeStudioApiClient) {
      root.WikitudeStudioApiClient = {};
    }
    root.WikitudeStudioApiClient.ObjectTargetCollectionResponse = factory(root.WikitudeStudioApiClient.ApiClient, root.WikitudeStudioApiClient.ObjectTargetCollectionResponseWto);
  }
}(this, function(ApiClient, ObjectTargetCollectionResponseWto) {
  'use strict';
  ...
  /**
   * The ObjectTargetCollectionResponse model module.
   * @module model/ObjectTargetCollectionResponse
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ObjectTargetCollectionResponse</code>.
   * @alias module:model/ObjectTargetCollectionResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ObjectTargetCollectionResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ObjectTargetCollectionResponse} obj Optional instance to populate.
   * @return {module:model/ObjectTargetCollectionResponse} The populated <code>ObjectTargetCollectionResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('wto')) {
        obj['wto'] = ApiClient.convertToType(data['wto'], [ObjectTargetCollectionResponseWto]);
      }
  ...
  /**
   * Version of the Wikitude SDK the WTO resource is generated for.
  ...
  /**
   * A list of generated WTO files.
   * @member {Array.<module:model/ObjectTargetCollectionResponseWto>} wto
   */
  exports.prototype['wto'] = undefined;
  /**
