...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WikitudeStudioApiClient.SimilarityCheckStatusResponseInputParamsImages = factory(root.WikitudeStudioApiClient.ApiClient);
  }
  ...
  /**
   * The SimilarityCheckStatusResponseInputParamsImages model module.
   * @module model/SimilarityCheckStatusResponseInputParamsImages
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>SimilarityCheckStatusResponseInputParamsImages</code>.
   * @alias module:model/SimilarityCheckStatusResponseInputParamsImages
   * @class
   */
  ...
  /**
   * Constructs a <code>SimilarityCheckStatusResponseInputParamsImages</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SimilarityCheckStatusResponseInputParamsImages} obj Optional instance to populate.
   * @return {module:model/SimilarityCheckStatusResponseInputParamsImages} The populated <code>SimilarityCheckStatusResponseInputParamsImages</code> instance.
   */
