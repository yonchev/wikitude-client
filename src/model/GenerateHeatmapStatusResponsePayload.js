...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WikitudeStudioApiClient.GenerateHeatmapStatusResponsePayload = factory(root.WikitudeStudioApiClient.ApiClient);
  }
  ...
  /**
   * The GenerateHeatmapStatusResponsePayload model module.
   * @module model/GenerateHeatmapStatusResponsePayload
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>GenerateHeatmapStatusResponsePayload</code>.
   * Object containing job relevant results.
   * @alias module:model/GenerateHeatmapStatusResponsePayload
   * @class
   */
  ...
  /**
   * Constructs a <code>GenerateHeatmapStatusResponsePayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GenerateHeatmapStatusResponsePayload} obj Optional instance to populate.
   * @return {module:model/GenerateHeatmapStatusResponsePayload} The populated <code>GenerateHeatmapStatusResponsePayload</code> instance.
   */
  ...
  /**
   * URL to the generated heatmap resource.
   * @member {String} url
   */
