...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateObjectTargetImagesBodyResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CreateObjectTargetImagesBodyResource'));
  } else {
    // Browser globals (root is window)
    if (!root.WikitudeStudioApiClient) {
      root.WikitudeStudioApiClient = {};
    }
    root.WikitudeStudioApiClient.CreateObjectTargetImagesBody = factory(root.WikitudeStudioApiClient.ApiClient, root.WikitudeStudioApiClient.CreateObjectTargetImagesBodyResource);
  }
}(this, function(ApiClient, CreateObjectTargetImagesBodyResource) {
  'use strict';
  ...
  /**
   * The CreateObjectTargetImagesBody model module.
   * @module model/CreateObjectTargetImagesBody
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>CreateObjectTargetImagesBody</code>.
   * @alias module:model/CreateObjectTargetImagesBody
   * @class
   */
  ...
  /**
   * Constructs a <code>CreateObjectTargetImagesBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateObjectTargetImagesBody} obj Optional instance to populate.
   * @return {module:model/CreateObjectTargetImagesBody} The populated <code>CreateObjectTargetImagesBody</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('resource')) {
        obj['resource'] = CreateObjectTargetImagesBodyResource.constructFromObject(data['resource']);
      }
  ...
  /**
   * @member {module:model/CreateObjectTargetImagesBodyResource} resource
   */
