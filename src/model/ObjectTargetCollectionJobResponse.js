...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WikitudeStudioApiClient.ObjectTargetCollectionJobResponse = factory(root.WikitudeStudioApiClient.ApiClient);
  }
  ...
  /**
   * The ObjectTargetCollectionJobResponse model module.
   * @module model/ObjectTargetCollectionJobResponse
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ObjectTargetCollectionJobResponse</code>.
   * @alias module:model/ObjectTargetCollectionJobResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ObjectTargetCollectionJobResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ObjectTargetCollectionJobResponse} obj Optional instance to populate.
   * @return {module:model/ObjectTargetCollectionJobResponse} The populated <code>ObjectTargetCollectionJobResponse</code> instance.
   */
