...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GenerateHeatmapResponseInputParams'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GenerateHeatmapResponseInputParams'));
  } else {
    // Browser globals (root is window)
    if (!root.WikitudeStudioApiClient) {
      root.WikitudeStudioApiClient = {};
    }
    root.WikitudeStudioApiClient.GenerateHeatmapResponse = factory(root.WikitudeStudioApiClient.ApiClient, root.WikitudeStudioApiClient.GenerateHeatmapResponseInputParams);
  }
}(this, function(ApiClient, GenerateHeatmapResponseInputParams) {
  'use strict';
  ...
  /**
   * The GenerateHeatmapResponse model module.
   * @module model/GenerateHeatmapResponse
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>GenerateHeatmapResponse</code>.
   * The task to create the heatmap is scheduled. The response body contains the initial job status. \&quot;Location\&quot;-header is the url to the GET endpoint that returns current job status information. It is recommended to query this endpoint after \&quot;estimatedLatency\&quot; milliseconds, and poll it afterwards every 5 seconds in case job status is still not \&quot;COMPLETED\&quot;. 
   * @alias module:model/GenerateHeatmapResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>GenerateHeatmapResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GenerateHeatmapResponse} obj Optional instance to populate.
   * @return {module:model/GenerateHeatmapResponse} The populated <code>GenerateHeatmapResponse</code> instance.
   */
