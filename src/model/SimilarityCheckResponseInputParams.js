...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WikitudeStudioApiClient.SimilarityCheckResponseInputParams = factory(root.WikitudeStudioApiClient.ApiClient, root.WikitudeStudioApiClient.SimilarityCheckStatusResponseInputParamsImages);
  }
  ...
  /**
   * The SimilarityCheckResponseInputParams model module.
   * @module model/SimilarityCheckResponseInputParams
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>SimilarityCheckResponseInputParams</code>.
   * Object containing job relevant parameters.
   * @alias module:model/SimilarityCheckResponseInputParams
   * @class
   */
  ...
  /**
   * Constructs a <code>SimilarityCheckResponseInputParams</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SimilarityCheckResponseInputParams} obj Optional instance to populate.
   * @return {module:model/SimilarityCheckResponseInputParams} The populated <code>SimilarityCheckResponseInputParams</code> instance.
   */
