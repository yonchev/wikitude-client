...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WikitudeStudioApiClient.CreateImageTargetCollectionBody = factory(root.WikitudeStudioApiClient.ApiClient, root.WikitudeStudioApiClient.CreateImageTargetCollectionBodyCloudArchive);
  }
  ...
  /**
   * The CreateImageTargetCollectionBody model module.
   * @module model/CreateImageTargetCollectionBody
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>CreateImageTargetCollectionBody</code>.
   * @alias module:model/CreateImageTargetCollectionBody
   * @class
   */
  ...
  /**
   * Constructs a <code>CreateImageTargetCollectionBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateImageTargetCollectionBody} obj Optional instance to populate.
   * @return {module:model/CreateImageTargetCollectionBody} The populated <code>CreateImageTargetCollectionBody</code> instance.
   */
