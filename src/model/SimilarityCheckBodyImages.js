...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WikitudeStudioApiClient.SimilarityCheckBodyImages = factory(root.WikitudeStudioApiClient.ApiClient);
  }
  ...
  /**
   * The SimilarityCheckBodyImages model module.
   * @module model/SimilarityCheckBodyImages
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>SimilarityCheckBodyImages</code>.
   * @alias module:model/SimilarityCheckBodyImages
   * @class
   */
  ...
  /**
   * Constructs a <code>SimilarityCheckBodyImages</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SimilarityCheckBodyImages} obj Optional instance to populate.
   * @return {module:model/SimilarityCheckBodyImages} The populated <code>SimilarityCheckBodyImages</code> instance.
   */
  ...
  /**
   * Optional - Specifies the maximum number of similar Targets.
   * @member {Number} maxCandidates
   */
  exports.prototype['maxCandidates'] = undefined;
