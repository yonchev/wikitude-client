...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WikitudeStudioApiClient.GenerateHeatmapResponseInputParams = factory(root.WikitudeStudioApiClient.ApiClient);
  }
  ...
  /**
   * The GenerateHeatmapResponseInputParams model module.
   * @module model/GenerateHeatmapResponseInputParams
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>GenerateHeatmapResponseInputParams</code>.
   * Object containing job relevant parameters.
   * @alias module:model/GenerateHeatmapResponseInputParams
   * @class
   */
  ...
  /**
   * Constructs a <code>GenerateHeatmapResponseInputParams</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GenerateHeatmapResponseInputParams} obj Optional instance to populate.
   * @return {module:model/GenerateHeatmapResponseInputParams} The populated <code>GenerateHeatmapResponseInputParams</code> instance.
   */
