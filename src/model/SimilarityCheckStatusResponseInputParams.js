...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SimilarityCheckStatusResponseInputParamsImages'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SimilarityCheckStatusResponseInputParamsImages'));
  } else {
    // Browser globals (root is window)
    if (!root.WikitudeStudioApiClient) {
      root.WikitudeStudioApiClient = {};
    }
    root.WikitudeStudioApiClient.SimilarityCheckStatusResponseInputParams = factory(root.WikitudeStudioApiClient.ApiClient, root.WikitudeStudioApiClient.SimilarityCheckStatusResponseInputParamsImages);
  }
}(this, function(ApiClient, SimilarityCheckStatusResponseInputParamsImages) {
  'use strict';
  ...
  /**
   * The SimilarityCheckStatusResponseInputParams model module.
   * @module model/SimilarityCheckStatusResponseInputParams
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>SimilarityCheckStatusResponseInputParams</code>.
   * Object containing job relevant parameters.
   * @alias module:model/SimilarityCheckStatusResponseInputParams
   * @class
   */
  ...
  /**
   * Constructs a <code>SimilarityCheckStatusResponseInputParams</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SimilarityCheckStatusResponseInputParams} obj Optional instance to populate.
   * @return {module:model/SimilarityCheckStatusResponseInputParams} The populated <code>SimilarityCheckStatusResponseInputParams</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('images')) {
        obj['images'] = ApiClient.convertToType(data['images'], [SimilarityCheckStatusResponseInputParamsImages]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/SimilarityCheckStatusResponseInputParamsImages>} images
   */
