...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CloudArchiveGenerationResponseInputParams'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CloudArchiveGenerationResponseInputParams'));
  } else {
    // Browser globals (root is window)
    if (!root.WikitudeStudioApiClient) {
      root.WikitudeStudioApiClient = {};
    }
    root.WikitudeStudioApiClient.CloudArchiveGenerationResponse = factory(root.WikitudeStudioApiClient.ApiClient, root.WikitudeStudioApiClient.CloudArchiveGenerationResponseInputParams);
  }
}(this, function(ApiClient, CloudArchiveGenerationResponseInputParams) {
  'use strict';
  ...
  /**
   * The CloudArchiveGenerationResponse model module.
   * @module model/CloudArchiveGenerationResponse
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>CloudArchiveGenerationResponse</code>.
   * @alias module:model/CloudArchiveGenerationResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>CloudArchiveGenerationResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CloudArchiveGenerationResponse} obj Optional instance to populate.
   * @return {module:model/CloudArchiveGenerationResponse} The populated <code>CloudArchiveGenerationResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('inputParams')) {
        obj['inputParams'] = CloudArchiveGenerationResponseInputParams.constructFromObject(data['inputParams']);
      }
  ...
  /**
   * @member {module:model/CloudArchiveGenerationResponseInputParams} inputParams
   */
