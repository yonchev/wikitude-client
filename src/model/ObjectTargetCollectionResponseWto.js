...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WikitudeStudioApiClient.ObjectTargetCollectionResponseWto = factory(root.WikitudeStudioApiClient.ApiClient);
  }
  ...
  /**
   * The ObjectTargetCollectionResponseWto model module.
   * @module model/ObjectTargetCollectionResponseWto
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ObjectTargetCollectionResponseWto</code>.
   * @alias module:model/ObjectTargetCollectionResponseWto
   * @class
   */
  ...
  /**
   * Constructs a <code>ObjectTargetCollectionResponseWto</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ObjectTargetCollectionResponseWto} obj Optional instance to populate.
   * @return {module:model/ObjectTargetCollectionResponseWto} The populated <code>ObjectTargetCollectionResponseWto</code> instance.
   */
  ...
  /**
   * Number of Targets bundled in the WTO resource.
   * @member {Number} nrOfTargets
   */
  exports.prototype['nrOfTargets'] = undefined;
  /**
   * Version of the Wikitude SDK the WTO resource was generated for.
