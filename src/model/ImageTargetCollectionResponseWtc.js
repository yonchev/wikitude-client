...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WikitudeStudioApiClient.ImageTargetCollectionResponseWtc = factory(root.WikitudeStudioApiClient.ApiClient);
  }
  ...
  /**
   * The ImageTargetCollectionResponseWtc model module.
   * @module model/ImageTargetCollectionResponseWtc
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ImageTargetCollectionResponseWtc</code>.
   * @alias module:model/ImageTargetCollectionResponseWtc
   * @class
   */
  ...
  /**
   * Constructs a <code>ImageTargetCollectionResponseWtc</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ImageTargetCollectionResponseWtc} obj Optional instance to populate.
   * @return {module:model/ImageTargetCollectionResponseWtc} The populated <code>ImageTargetCollectionResponseWtc</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('nrOfTargets')) {
        obj['nrOfTargets'] = ApiClient.convertToType(data['nrOfTargets'], 'Number');
      }
  ...
  /**
   * URL to the WTC resource.
   * @member {String} url
   */
  exports.prototype['url'] = undefined;
  /**
   * Number of Targets bundled in the WTC resource.
   * @member {Number} nrOfTargets
   */
  exports.prototype['nrOfTargets'] = undefined;
  /**
