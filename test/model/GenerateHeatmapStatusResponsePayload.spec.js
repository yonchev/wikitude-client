...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.GenerateHeatmapStatusResponsePayload();
  });
  ...
  describe('GenerateHeatmapStatusResponsePayload', function() {
    it('should create an instance of GenerateHeatmapStatusResponsePayload', function() {
      // uncomment below and update the code to test GenerateHeatmapStatusResponsePayload
      //var instance = new WikitudeStudioApiClient.GenerateHeatmapStatusResponsePayload();
      //expect(instance).to.be.a(WikitudeStudioApiClient.GenerateHeatmapStatusResponsePayload);
    });
