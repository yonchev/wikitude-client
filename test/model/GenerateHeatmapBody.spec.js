...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.GenerateHeatmapBody();
  });
  ...
  describe('GenerateHeatmapBody', function() {
    it('should create an instance of GenerateHeatmapBody', function() {
      // uncomment below and update the code to test GenerateHeatmapBody
      //var instance = new WikitudeStudioApiClient.GenerateHeatmapBody();
      //expect(instance).to.be.a(WikitudeStudioApiClient.GenerateHeatmapBody);
    });
