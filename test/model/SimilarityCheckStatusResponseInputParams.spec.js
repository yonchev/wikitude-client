...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.SimilarityCheckStatusResponseInputParams();
  });
  ...
  describe('SimilarityCheckStatusResponseInputParams', function() {
    it('should create an instance of SimilarityCheckStatusResponseInputParams', function() {
      // uncomment below and update the code to test SimilarityCheckStatusResponseInputParams
      //var instance = new WikitudeStudioApiClient.SimilarityCheckStatusResponseInputParams();
      //expect(instance).to.be.a(WikitudeStudioApiClient.SimilarityCheckStatusResponseInputParams);
    });
