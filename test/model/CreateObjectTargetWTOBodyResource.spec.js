...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.CreateObjectTargetWTOBodyResource();
  });
  ...
  describe('CreateObjectTargetWTOBodyResource', function() {
    it('should create an instance of CreateObjectTargetWTOBodyResource', function() {
      // uncomment below and update the code to test CreateObjectTargetWTOBodyResource
      //var instance = new WikitudeStudioApiClient.CreateObjectTargetWTOBodyResource();
      //expect(instance).to.be.a(WikitudeStudioApiClient.CreateObjectTargetWTOBodyResource);
    });
