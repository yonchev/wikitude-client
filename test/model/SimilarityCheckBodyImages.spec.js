...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.SimilarityCheckBodyImages();
  });
  ...
  describe('SimilarityCheckBodyImages', function() {
    it('should create an instance of SimilarityCheckBodyImages', function() {
      // uncomment below and update the code to test SimilarityCheckBodyImages
      //var instance = new WikitudeStudioApiClient.SimilarityCheckBodyImages();
      //expect(instance).to.be.a(WikitudeStudioApiClient.SimilarityCheckBodyImages);
    });
    ...
    it('should have the property maxCandidates (base name: "maxCandidates")', function() {
      // uncomment below and update the code to test the property maxCandidates
      //var instance = new WikitudeStudioApiClient.SimilarityCheckBodyImages();
      //expect(instance).to.be();
    });
