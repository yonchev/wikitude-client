...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.GenerateHeatmapResponse();
  });
  ...
  describe('GenerateHeatmapResponse', function() {
    it('should create an instance of GenerateHeatmapResponse', function() {
      // uncomment below and update the code to test GenerateHeatmapResponse
      //var instance = new WikitudeStudioApiClient.GenerateHeatmapResponse();
      //expect(instance).to.be.a(WikitudeStudioApiClient.GenerateHeatmapResponse);
    });
