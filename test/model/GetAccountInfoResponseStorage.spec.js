...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.GetAccountInfoResponseStorage();
  });
  ...
  describe('GetAccountInfoResponseStorage', function() {
    it('should create an instance of GetAccountInfoResponseStorage', function() {
      // uncomment below and update the code to test GetAccountInfoResponseStorage
      //var instance = new WikitudeStudioApiClient.GetAccountInfoResponseStorage();
      //expect(instance).to.be.a(WikitudeStudioApiClient.GetAccountInfoResponseStorage);
    });
