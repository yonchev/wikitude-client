...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.ImageTargetCollectionResponse();
  });
  ...
  describe('ImageTargetCollectionResponse', function() {
    it('should create an instance of ImageTargetCollectionResponse', function() {
      // uncomment below and update the code to test ImageTargetCollectionResponse
      //var instance = new WikitudeStudioApiClient.ImageTargetCollectionResponse();
      //expect(instance).to.be.a(WikitudeStudioApiClient.ImageTargetCollectionResponse);
    });
    ...
    it('should have the property wtc (base name: "wtc")', function() {
      // uncomment below and update the code to test the property wtc
      //var instance = new WikitudeStudioApiClient.ImageTargetCollectionResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property cloudArchive (base name: "cloudArchive")', function() {
      // uncomment below and update the code to test the property cloudArchive
      //var instance = new WikitudeStudioApiClient.ImageTargetCollectionResponse();
      //expect(instance).to.be();
    });
