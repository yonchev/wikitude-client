...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.CreateObjectTargetWTOBody();
  });
  ...
  describe('CreateObjectTargetWTOBody', function() {
    it('should create an instance of CreateObjectTargetWTOBody', function() {
      // uncomment below and update the code to test CreateObjectTargetWTOBody
      //var instance = new WikitudeStudioApiClient.CreateObjectTargetWTOBody();
      //expect(instance).to.be.a(WikitudeStudioApiClient.CreateObjectTargetWTOBody);
    });
