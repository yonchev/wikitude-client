...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.CreateImageTargetCollectionBodyCloudArchive();
  });
  ...
  describe('CreateImageTargetCollectionBodyCloudArchive', function() {
    it('should create an instance of CreateImageTargetCollectionBodyCloudArchive', function() {
      // uncomment below and update the code to test CreateImageTargetCollectionBodyCloudArchive
      //var instance = new WikitudeStudioApiClient.CreateImageTargetCollectionBodyCloudArchive();
      //expect(instance).to.be.a(WikitudeStudioApiClient.CreateImageTargetCollectionBodyCloudArchive);
    });
