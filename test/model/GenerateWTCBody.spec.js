...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.GenerateWTCBody();
  });
  ...
  describe('GenerateWTCBody', function() {
    it('should create an instance of GenerateWTCBody', function() {
      // uncomment below and update the code to test GenerateWTCBody
      //var instance = new WikitudeStudioApiClient.GenerateWTCBody();
      //expect(instance).to.be.a(WikitudeStudioApiClient.GenerateWTCBody);
    });
