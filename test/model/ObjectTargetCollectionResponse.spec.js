...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.ObjectTargetCollectionResponse();
  });
  ...
  describe('ObjectTargetCollectionResponse', function() {
    it('should create an instance of ObjectTargetCollectionResponse', function() {
      // uncomment below and update the code to test ObjectTargetCollectionResponse
      //var instance = new WikitudeStudioApiClient.ObjectTargetCollectionResponse();
      //expect(instance).to.be.a(WikitudeStudioApiClient.ObjectTargetCollectionResponse);
    });
    ...
    it('should have the property wto (base name: "wto")', function() {
      // uncomment below and update the code to test the property wto
      //var instance = new WikitudeStudioApiClient.ObjectTargetCollectionResponse();
      //expect(instance).to.be();
    });
