...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.UpdateObjectTargetCollectionBody();
  });
  ...
  describe('UpdateObjectTargetCollectionBody', function() {
    it('should create an instance of UpdateObjectTargetCollectionBody', function() {
      // uncomment below and update the code to test UpdateObjectTargetCollectionBody
      //var instance = new WikitudeStudioApiClient.UpdateObjectTargetCollectionBody();
      //expect(instance).to.be.a(WikitudeStudioApiClient.UpdateObjectTargetCollectionBody);
    });
