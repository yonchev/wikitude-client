...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.GenerateWTOBody();
  });
  ...
  describe('GenerateWTOBody', function() {
    it('should create an instance of GenerateWTOBody', function() {
      // uncomment below and update the code to test GenerateWTOBody
      //var instance = new WikitudeStudioApiClient.GenerateWTOBody();
      //expect(instance).to.be.a(WikitudeStudioApiClient.GenerateWTOBody);
    });
