...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.CreateImageTargetCollectionBody();
  });
  ...
  describe('CreateImageTargetCollectionBody', function() {
    it('should create an instance of CreateImageTargetCollectionBody', function() {
      // uncomment below and update the code to test CreateImageTargetCollectionBody
      //var instance = new WikitudeStudioApiClient.CreateImageTargetCollectionBody();
      //expect(instance).to.be.a(WikitudeStudioApiClient.CreateImageTargetCollectionBody);
    });
