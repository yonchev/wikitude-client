...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.RenameObjectTargetBody();
  });
  ...
  describe('RenameObjectTargetBody', function() {
    it('should create an instance of RenameObjectTargetBody', function() {
      // uncomment below and update the code to test RenameObjectTargetBody
      //var instance = new WikitudeStudioApiClient.RenameObjectTargetBody();
      //expect(instance).to.be.a(WikitudeStudioApiClient.RenameObjectTargetBody);
    });
