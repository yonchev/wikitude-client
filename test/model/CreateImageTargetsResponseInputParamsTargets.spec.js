...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.CreateImageTargetsResponseInputParamsTargets();
  });
  ...
  describe('CreateImageTargetsResponseInputParamsTargets', function() {
    it('should create an instance of CreateImageTargetsResponseInputParamsTargets', function() {
      // uncomment below and update the code to test CreateImageTargetsResponseInputParamsTargets
      //var instance = new WikitudeStudioApiClient.CreateImageTargetsResponseInputParamsTargets();
      //expect(instance).to.be.a(WikitudeStudioApiClient.CreateImageTargetsResponseInputParamsTargets);
    });
