...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.SimilarityCheckResponseInputParams();
  });
  ...
  describe('SimilarityCheckResponseInputParams', function() {
    it('should create an instance of SimilarityCheckResponseInputParams', function() {
      // uncomment below and update the code to test SimilarityCheckResponseInputParams
      //var instance = new WikitudeStudioApiClient.SimilarityCheckResponseInputParams();
      //expect(instance).to.be.a(WikitudeStudioApiClient.SimilarityCheckResponseInputParams);
    });
