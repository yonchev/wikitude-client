...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.GetAccountInfoResponse();
  });
  ...
  describe('GetAccountInfoResponse', function() {
    it('should create an instance of GetAccountInfoResponse', function() {
      // uncomment below and update the code to test GetAccountInfoResponse
      //var instance = new WikitudeStudioApiClient.GetAccountInfoResponse();
      //expect(instance).to.be.a(WikitudeStudioApiClient.GetAccountInfoResponse);
    });
    ...
    it('should have the property publicUserId (base name: "publicUserId")', function() {
      // uncomment below and update the code to test the property publicUserId
      //var instance = new WikitudeStudioApiClient.GetAccountInfoResponse();
      //expect(instance).to.be();
    });
