...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.SimilarityCheckStatusResponseInputParamsImages();
  });
  ...
  describe('SimilarityCheckStatusResponseInputParamsImages', function() {
    it('should create an instance of SimilarityCheckStatusResponseInputParamsImages', function() {
      // uncomment below and update the code to test SimilarityCheckStatusResponseInputParamsImages
      //var instance = new WikitudeStudioApiClient.SimilarityCheckStatusResponseInputParamsImages();
      //expect(instance).to.be.a(WikitudeStudioApiClient.SimilarityCheckStatusResponseInputParamsImages);
    });
