...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.CreateImageTargetsResponse();
  });
  ...
  describe('CreateImageTargetsResponse', function() {
    it('should create an instance of CreateImageTargetsResponse', function() {
      // uncomment below and update the code to test CreateImageTargetsResponse
      //var instance = new WikitudeStudioApiClient.CreateImageTargetsResponse();
      //expect(instance).to.be.a(WikitudeStudioApiClient.CreateImageTargetsResponse);
    });
