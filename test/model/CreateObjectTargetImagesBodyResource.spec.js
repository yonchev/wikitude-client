...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.CreateObjectTargetImagesBodyResource();
  });
  ...
  describe('CreateObjectTargetImagesBodyResource', function() {
    it('should create an instance of CreateObjectTargetImagesBodyResource', function() {
      // uncomment below and update the code to test CreateObjectTargetImagesBodyResource
      //var instance = new WikitudeStudioApiClient.CreateObjectTargetImagesBodyResource();
      //expect(instance).to.be.a(WikitudeStudioApiClient.CreateObjectTargetImagesBodyResource);
    });
    ...
    it('should have the property fov (base name: "fov")', function() {
      // uncomment below and update the code to test the property fov
      //var instance = new WikitudeStudioApiClient.CreateObjectTargetImagesBodyResource();
      //expect(instance).to.be();
    });
