...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.ObjectTargetJobResponse();
  });
  ...
  describe('ObjectTargetJobResponse', function() {
    it('should create an instance of ObjectTargetJobResponse', function() {
      // uncomment below and update the code to test ObjectTargetJobResponse
      //var instance = new WikitudeStudioApiClient.ObjectTargetJobResponse();
      //expect(instance).to.be.a(WikitudeStudioApiClient.ObjectTargetJobResponse);
    });
