...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.SimilarityCheckBody();
  });
  ...
  describe('SimilarityCheckBody', function() {
    it('should create an instance of SimilarityCheckBody', function() {
      // uncomment below and update the code to test SimilarityCheckBody
      //var instance = new WikitudeStudioApiClient.SimilarityCheckBody();
      //expect(instance).to.be.a(WikitudeStudioApiClient.SimilarityCheckBody);
    });
