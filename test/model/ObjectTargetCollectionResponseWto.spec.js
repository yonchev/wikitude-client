...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.ObjectTargetCollectionResponseWto();
  });
  ...
  describe('ObjectTargetCollectionResponseWto', function() {
    it('should create an instance of ObjectTargetCollectionResponseWto', function() {
      // uncomment below and update the code to test ObjectTargetCollectionResponseWto
      //var instance = new WikitudeStudioApiClient.ObjectTargetCollectionResponseWto();
      //expect(instance).to.be.a(WikitudeStudioApiClient.ObjectTargetCollectionResponseWto);
    });

    it('should have the property nrOfTargets (base name: "nrOfTargets")', function() {
      // uncomment below and update the code to test the property nrOfTargets
      //var instance = new WikitudeStudioApiClient.ObjectTargetCollectionResponseWto();
