...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.ObjectTargetResponseResource();
  });
  ...
  describe('ObjectTargetResponseResource', function() {
    it('should create an instance of ObjectTargetResponseResource', function() {
      // uncomment below and update the code to test ObjectTargetResponseResource
      //var instance = new WikitudeStudioApiClient.ObjectTargetResponseResource();
      //expect(instance).to.be.a(WikitudeStudioApiClient.ObjectTargetResponseResource);
    });
