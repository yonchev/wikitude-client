...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.CreateImageTargetsBody();
  });
  ...
  describe('CreateImageTargetsBody', function() {
    it('should create an instance of CreateImageTargetsBody', function() {
      // uncomment below and update the code to test CreateImageTargetsBody
      //var instance = new WikitudeStudioApiClient.CreateImageTargetsBody();
      //expect(instance).to.be.a(WikitudeStudioApiClient.CreateImageTargetsBody);
    });
