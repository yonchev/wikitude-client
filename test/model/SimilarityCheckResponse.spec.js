...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.SimilarityCheckResponse();
  });
  ...
  describe('SimilarityCheckResponse', function() {
    it('should create an instance of SimilarityCheckResponse', function() {
      // uncomment below and update the code to test SimilarityCheckResponse
      //var instance = new WikitudeStudioApiClient.SimilarityCheckResponse();
      //expect(instance).to.be.a(WikitudeStudioApiClient.SimilarityCheckResponse);
    });
