...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.CreateObjectTargetCollectionBody();
  });
  ...
  describe('CreateObjectTargetCollectionBody', function() {
    it('should create an instance of CreateObjectTargetCollectionBody', function() {
      // uncomment below and update the code to test CreateObjectTargetCollectionBody
      //var instance = new WikitudeStudioApiClient.CreateObjectTargetCollectionBody();
      //expect(instance).to.be.a(WikitudeStudioApiClient.CreateObjectTargetCollectionBody);
    });
