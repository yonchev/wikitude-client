...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.ExtendObjectTargetBody();
  });
  ...
  describe('ExtendObjectTargetBody', function() {
    it('should create an instance of ExtendObjectTargetBody', function() {
      // uncomment below and update the code to test ExtendObjectTargetBody
      //var instance = new WikitudeStudioApiClient.ExtendObjectTargetBody();
      //expect(instance).to.be.a(WikitudeStudioApiClient.ExtendObjectTargetBody);
    });
