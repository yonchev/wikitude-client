...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.ObjectTargetCollectionJobResponse();
  });
  ...
  describe('ObjectTargetCollectionJobResponse', function() {
    it('should create an instance of ObjectTargetCollectionJobResponse', function() {
      // uncomment below and update the code to test ObjectTargetCollectionJobResponse
      //var instance = new WikitudeStudioApiClient.ObjectTargetCollectionJobResponse();
      //expect(instance).to.be.a(WikitudeStudioApiClient.ObjectTargetCollectionJobResponse);
    });
