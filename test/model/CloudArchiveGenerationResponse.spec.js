...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.CloudArchiveGenerationResponse();
  });
  ...
  describe('CloudArchiveGenerationResponse', function() {
    it('should create an instance of CloudArchiveGenerationResponse', function() {
      // uncomment below and update the code to test CloudArchiveGenerationResponse
      //var instance = new WikitudeStudioApiClient.CloudArchiveGenerationResponse();
      //expect(instance).to.be.a(WikitudeStudioApiClient.CloudArchiveGenerationResponse);
    });
