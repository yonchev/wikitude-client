...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.ImageTargetCollectionResponseCloudArchive();
  });
  ...
  describe('ImageTargetCollectionResponseCloudArchive', function() {
    it('should create an instance of ImageTargetCollectionResponseCloudArchive', function() {
      // uncomment below and update the code to test ImageTargetCollectionResponseCloudArchive
      //var instance = new WikitudeStudioApiClient.ImageTargetCollectionResponseCloudArchive();
      //expect(instance).to.be.a(WikitudeStudioApiClient.ImageTargetCollectionResponseCloudArchive);
    });
