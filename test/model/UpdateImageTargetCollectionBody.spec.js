...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.UpdateImageTargetCollectionBody();
  });
  ...
  describe('UpdateImageTargetCollectionBody', function() {
    it('should create an instance of UpdateImageTargetCollectionBody', function() {
      // uncomment below and update the code to test UpdateImageTargetCollectionBody
      //var instance = new WikitudeStudioApiClient.UpdateImageTargetCollectionBody();
      //expect(instance).to.be.a(WikitudeStudioApiClient.UpdateImageTargetCollectionBody);
    });
