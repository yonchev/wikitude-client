...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.ObjectTargetResponseWtoFile();
  });
  ...
  describe('ObjectTargetResponseWtoFile', function() {
    it('should create an instance of ObjectTargetResponseWtoFile', function() {
      // uncomment below and update the code to test ObjectTargetResponseWtoFile
      //var instance = new WikitudeStudioApiClient.ObjectTargetResponseWtoFile();
      //expect(instance).to.be.a(WikitudeStudioApiClient.ObjectTargetResponseWtoFile);
    });

    it('should have the property transformedJSONUri (base name: "transformedJSONUri")', function() {
      // uncomment below and update the code to test the property transformedJSONUri
      //var instance = new WikitudeStudioApiClient.ObjectTargetResponseWtoFile();
    ...
    it('should have the property pointCount (base name: "pointCount")', function() {
      // uncomment below and update the code to test the property pointCount
      //var instance = new WikitudeStudioApiClient.ObjectTargetResponseWtoFile();
      //expect(instance).to.be();
    });
