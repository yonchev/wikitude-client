...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.ImageTargetCollectionResponseWtc();
  });
  ...
  describe('ImageTargetCollectionResponseWtc', function() {
    it('should create an instance of ImageTargetCollectionResponseWtc', function() {
      // uncomment below and update the code to test ImageTargetCollectionResponseWtc
      //var instance = new WikitudeStudioApiClient.ImageTargetCollectionResponseWtc();
      //expect(instance).to.be.a(WikitudeStudioApiClient.ImageTargetCollectionResponseWtc);
    });
