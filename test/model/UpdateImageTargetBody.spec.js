...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.UpdateImageTargetBody();
  });
  ...
  describe('UpdateImageTargetBody', function() {
    it('should create an instance of UpdateImageTargetBody', function() {
      // uncomment below and update the code to test UpdateImageTargetBody
      //var instance = new WikitudeStudioApiClient.UpdateImageTargetBody();
      //expect(instance).to.be.a(WikitudeStudioApiClient.UpdateImageTargetBody);
    });
