...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.SimilarityCheckStatusResponseCandidates();
  });
  ...
  describe('SimilarityCheckStatusResponseCandidates', function() {
    it('should create an instance of SimilarityCheckStatusResponseCandidates', function() {
      // uncomment below and update the code to test SimilarityCheckStatusResponseCandidates
      //var instance = new WikitudeStudioApiClient.SimilarityCheckStatusResponseCandidates();
      //expect(instance).to.be.a(WikitudeStudioApiClient.SimilarityCheckStatusResponseCandidates);
    });
