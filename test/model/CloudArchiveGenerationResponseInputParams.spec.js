...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.CloudArchiveGenerationResponseInputParams();
  });
  ...
  describe('CloudArchiveGenerationResponseInputParams', function() {
    it('should create an instance of CloudArchiveGenerationResponseInputParams', function() {
      // uncomment below and update the code to test CloudArchiveGenerationResponseInputParams
      //var instance = new WikitudeStudioApiClient.CloudArchiveGenerationResponseInputParams();
      //expect(instance).to.be.a(WikitudeStudioApiClient.CloudArchiveGenerationResponseInputParams);
    });
    ...
    it('should have the property validityKeyDate (base name: "validityKeyDate")', function() {
      // uncomment below and update the code to test the property validityKeyDate
      //var instance = new WikitudeStudioApiClient.CloudArchiveGenerationResponseInputParams();
      //expect(instance).to.be();
    });
