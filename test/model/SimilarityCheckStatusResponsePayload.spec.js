...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.SimilarityCheckStatusResponsePayload();
  });
  ...
  describe('SimilarityCheckStatusResponsePayload', function() {
    it('should create an instance of SimilarityCheckStatusResponsePayload', function() {
      // uncomment below and update the code to test SimilarityCheckStatusResponsePayload
      //var instance = new WikitudeStudioApiClient.SimilarityCheckStatusResponsePayload();
      //expect(instance).to.be.a(WikitudeStudioApiClient.SimilarityCheckStatusResponsePayload);
    });
