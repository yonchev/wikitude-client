...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.ImageTargetApi();
  });
  ...
  describe('ImageTargetApi', function() {
    describe('createImageTargets', function() {
      it('should call createImageTargets successfully', function(done) {
        //uncomment below and update the code to test createImageTargets
        //instance.createImageTargets(function(error) {
    ...
    describe('deleteImageTarget', function() {
      it('should call deleteImageTarget successfully', function(done) {
        //uncomment below and update the code to test deleteImageTarget
        //instance.deleteImageTarget(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getImageTarget', function() {
      it('should call getImageTarget successfully', function(done) {
        //uncomment below and update the code to test getImageTarget
        //instance.getImageTarget(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getImageTargetStatus', function() {
      it('should call getImageTargetStatus successfully', function(done) {
        //uncomment below and update the code to test getImageTargetStatus
        //instance.getImageTargetStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getImageTargets', function() {
      it('should call getImageTargets successfully', function(done) {
        //uncomment below and update the code to test getImageTargets
        //instance.getImageTargets(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateImageTarget', function() {
      it('should call updateImageTarget successfully', function(done) {
        //uncomment below and update the code to test updateImageTarget
        //instance.updateImageTarget(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
