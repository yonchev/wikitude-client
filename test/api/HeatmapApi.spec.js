...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WikitudeStudioApiClient.HeatmapApi();
  });
  ...
  describe('HeatmapApi', function() {
    describe('generateHeatmap', function() {
      it('should call generateHeatmap successfully', function(done) {
        //uncomment below and update the code to test generateHeatmap
        //instance.generateHeatmap(function(error) {
    ...
    describe('getHeatmapStatus', function() {
      it('should call getHeatmapStatus successfully', function(done) {
        //uncomment below and update the code to test getHeatmapStatus
        //instance.getHeatmapStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
